...
class movieQuery
{
	static String movieRatings = "C:/dbms/tomcat/webapps/lab31/WEB-INF/classes/movieratings.csv" ;
	static String movieinfo  = "C:/dbms/tomcat/webapps/lab31/WEB-INF/classes/movieinfo.csv";
	Map<String,String> directorMovie = new HashMap<String,String>() ;
	Map<String,List<String> > actorsMovie = new HashMap<String,List<String> >();
	Map<String,List<String> > yearsMovie = new HashMap<String,List<String> >();
	Map<String,String[] > movieVars = new HashMap<String,String[] >();
	Map<String, Double > ratingMoive = new HashMap<String,Double> ();
	...
	String removeMovie(String Title,String filename) throws IOException
	 ...
	 public String addMovieInfo(String Movie) throws IOException
	 {
	 ...
	 public String addMovierating(String Movie) throws IOException
	 {
				 String[] check = Movie.split(":");
				 if(check.length < 2)
				 {
	 ...
	 public String removeMovieInfo(String queryString) throws IOException
	 {
	 ...
	 public String removeMovieRating(String queryString) throws IOException
	 {
	 ...
	 public String changeRating (String queryString) throws IOException
	 {
	 ...
	 public String changeInfo(String queryString) throws IOException
	 {

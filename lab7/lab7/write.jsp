			...
			<div class="navbar">
			  <div class="navbar-inner">
			    ...
			    <ul class="nav pull-right">
			      ...
			      <li class="active" ><a href="/lab7/write.jsp">Movie Details</a></li>
		...
		<div class="row9">
			...
			<table class="table table-striped" is="myTable">
              ...
              <tr style="display:none" id="addNewMovie">
              	<td>0</td>
              	<form method="post" action="/lab7/Write">
              	<td>
              		<input class="medium" type="text" name="moviename" required/>
              	</td>
              	<td>
              		<input class="medium" type="text" name="yor" required/></td> 
              	<td>
              		<input class="medium" type="text" name="Producer" required/>
              	</td> 
              	<td>
              		<input class="medium" type="text" name="Director" required/>
              	</td>
              	<td>
              		<input class="medium" type="text" name="Actor" placeholder="actors names with coma" required/>
              	</td>
              	<td>
              		<button type="medium" value="add" name="button" class="btn btn-primary">Add</button>
              	</td>
              </form>
              	</tr>

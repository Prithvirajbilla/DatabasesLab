...
public class getMovieAward extends HttpServlet  
{
	...
	public String getHtmlView()
	{
		...
		String q = "SELECT * FROM movieawards";
		Statement ppt = null;
		ResultSet rs  = null;
		rowcount = 0;
		try
		{
			...
			while(rs.next())
			{
				...
				res=res +"<tr><td>"+Integer.toString(rowcount)+"</td>"+
                  ...
                  "\" data-url=\"/lab7/WriteAward\" data-title=\"Enter movie name\">"+rs.getString(1) +"</a></td>"+
                  "<td><a href=\"#\" id=\"yoa"+Integer.toString(rowcount)+"\" data-type=\"number\" data-pk=\""+rs.getString(1)+"\" data-url=\"/lab7/WriteAward\" data-title=\"Enter Year\">"+rs.getString(2)
                  +"</a></td> <td><a href=\"#\" id=\"awardname"+Integer.toString(rowcount)+"\" data-type=\"text\" data-pk=\""+rs.getString(1)+"\" data-url=\"/lab7/WriteAward\" data-title=\"Enter Producer\">"+
                  rs.getString(3)+"</a></td>"+
                  "<td><form method=\"post\" action=\"/lab7/WriteAward\"><button type=\"submit\" value=\""+
	...
	public String getJsView()
	{
		...
		for(int i = 1; i <= rowcount; i++)
		{
			res = res + "$('#moviename"+Integer.toString(i)+"').editable();";
   	 		res = res +  "$('#yoa"+Integer.toString(i)+"').editable();";
   			res = res + "$('#awardname"+Integer.toString(i)+"').editable();";
		}
		return res;
	}
